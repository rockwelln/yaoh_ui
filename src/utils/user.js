...
export const pages = Object.freeze({
    ...
    system_logs: 25,
    provisioning: 26,
    provisioning_nemo_reports_sfr: 27,
...
export const accesses = Object.freeze({
  ...
  provisioning_nemo_reports_sfr: "provisioning.nemo_reports_sfr",
  data: "data",
  settings: "settings",
...
export const modules = Object.freeze({
    ...
    draas: 'draas',
    provisioning: 'provisioning',
    provisioning_nemo_reports_sfr: "provisioning_nemo_reports_sfr",
    bulk: 'bulk',
    orchestration: 'orchestration',
    telenet: 'telenet',
