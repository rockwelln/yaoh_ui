...
import { fetchPostCreateTrunkGroupUser } from "../../store/actions";
...
export class PhoneNumbersTab extends Component {
  ...
  assignNumbers = numbersToAssign => {
    const data = {
      range: {
        minPhoneNumber: numbersToAssign.numbers[0].phoneNumber,
        maxPhoneNumber:
          numbersToAssign.numbers.length > 1
            ? numbersToAssign.numbers[numbersToAssign.numbers.length - 1]
                .phoneNumber
            : numbersToAssign.numbers[0].phoneNumber
      }
