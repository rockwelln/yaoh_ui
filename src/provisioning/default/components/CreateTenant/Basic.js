...
export class Basic extends Component {
  ...
  componentDidMount() {
    this.setState({ isLoadingConfig: true, isLoadingResellers: true }, () => {
      this.props.fetchGetSelfcareURL().then(() =>
        this.setState({
          isLoadingConfig: false,
          overwriteID: this.props.selfcareUrl?.tenant_id_autogenerated,
        })
      );
      this.props
        .fetchGetResellers()
          ...
          <React.Fragment>
            ...
            {(!this.props.createTenant.sync.ou ||
              ...
              <React.Fragment>
                ...
                {this.props?.selfcareUrl?.reseller?.tenant && (
                  <Row className={"margin-1"}>
                    <FormGroup controlId="resellerId">
                      ...
                      <Col md={9}>
                        <Select
                          value={this.props.createTenant.resellerId}
                          onChange={(selected) => {
                            this.props.changeResellerIdOfTenant(selected);
                          }}
                          options={[
